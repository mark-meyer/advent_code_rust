...
static ROCK:Play = Play {hand: Hand::Rock, beats: Hand::Scissors, loses:Hand::Paper};
static PAPER:Play = Play {hand:Hand::Paper, beats: Hand::Rock, loses:Hand::Scissors};
static SCISSORS:Play = Play {hand:Hand::Scissors, beats: Hand::Paper, loses:Hand::Rock};
